...
export function PlanBudgetRecovery({
 ...
 <div>
 <p className="text-sm font-semibold text-foreground">Plan exceeds your budget</p>
 <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
 Claude estimated <strong className="text-foreground">{estimatedStt.toFixed(2)} STT</strong>{' '}
 for this goal, but you asked for{' '}
 <strong className="text-foreground">{budgetStt.toFixed(2)} STT</strong>. Current limits:
