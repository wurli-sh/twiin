...
export const tasks = sqliteTable("tasks", {
  ...
  lastAbortReason: text("last_abort_reason"),
...
export const steps = sqliteTable(
  "steps",
  {
    ...
    consensusValidators: integer("consensus_validators"),
    consensusReceiptId: text("consensus_receipt_id"),
    consensusMedianCostWei: text("consensus_median_cost_wei"),
