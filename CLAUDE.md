...
| Phase               | Status      | Notes                                           |
| ------------------- | ----------- | ----------------------------------------------- |
| 1 — Contracts       | ✅ Complete | 81/81 tests passing                             |
| 2 — Shared package  | 🔜 Next     | ABIs, types, constants, digest, 6551 helper     |
...
- Tests: Hardhat + chai + ethers v6 (hardhat-toolbox); 81 tests, all green
...
2. **Shared package** 🔜 — ABIs/types, `addresses.json`, chain constants, helpers
